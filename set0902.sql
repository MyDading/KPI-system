...
CREATE TABLE `kpi_msg`  (
  ...
  `KPI` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `KPI輔項` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `KPI細項` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `審核方式` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `評核計算方式` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `目標值` int(10) NULL DEFAULT NULL,
  `比重` int(10) NULL DEFAULT NULL,
  `達成數` int(10) NULL DEFAULT NULL,
  `目標數` int(10) NULL DEFAULT NULL,
  `達成率` int(10) NOT NULL,
  `項次` int(10) NULL DEFAULT NULL,
  `項目` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `系統編號` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `細項` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `更新時間` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
  `第幾周` int(10) NULL DEFAULT NULL,
  `工號` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `kpi_msg` VALUES (54, '專案質量', '進度管理', '测试1.负责专案进度更新；\r\n2.以专案进度排程表和测试进度时程表进行管控。', '1.JIRA留言；\r\n2.排程表每日更新。', '量测达成数/总量测数', 1001, 88, 10101, 1010, 1010, 101010, '101010', '101010', '041010', '2019-08-23 14:30:15', NULL, '18006122', '呂運鼎');
INSERT INTO `kpi_msg` VALUES (55, '專案質量', '準確度', '1.通過學習每個測項，及程序開發需求文檔，分析所開發的程序需要提供的數據和功能，不出現錯誤參數，和功能與需求報告不符的情況', '1.程序開發需求文檔審核 \r\n2.上級發出的需求信息', '量測達成數/總量測數', 10010, 50, 14141, 41414, 4141, 4141, '4141', '14141', '4141', '2019-08-23 14:32:55', NULL, '18006122', '呂運鼎');
INSERT INTO `kpi_msg` VALUES (56, '專案質量', '出錯率', '1.開發需求內容，在程序開發前前解讀準確，無出現開發項目不符合需求的情況。', '1.申請單項目審核 ；2.程序需求文擋審核。', '量測達成數/總量測數', 100, 45, 4141, 141, 141, 141, '414', '14141', '414', '2019-08-23 14:33:05', NULL, '18006122', '呂運鼎');
INSERT INTO `kpi_msg` VALUES (57, '專案質量', '客戶滿意度', '1.通过学习每个测项，及程序开发文档，\r\n分析所开发的程序所需要提供的数据和功能。', '1.程序开发需求文档\r\n审核；2.上级发出的\r\n需求信息。', '量测达成数/总量测数', 100, 45, 4141, 4141, 4141, 141, '4141', '141', '141', '2019-08-23 14:33:14', NULL, '18006122', '呂運鼎');
...
CREATE TABLE `user_info`  (
  ...
  `jurisdiction` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `user_info` VALUES (1, '林靜忠', 'INNOLUX', '81823', 'set', NULL, '18013950', '18013950', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'l');
INSERT INTO `user_info` VALUES (2, '呂運鼎', 'INNOLUX', '87541', 'set', NULL, '18006122', '18006122', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'a');
INSERT INTO `user_info` VALUES (3, '何文廣', 'INNOLUX', '82112', 'set', NULL, '17008224', '17008224', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (4, '羅曉', 'INNOLUX', '87975', 'set', NULL, '17015471', '17015471', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (5, '林達', 'INNOLUX', '82134', 'set', NULL, '14049595', '14049595', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'l');
INSERT INTO `user_info` VALUES (6, '黃小如', 'INNOLUX', '80783', 'set', NULL, '17022338', '17022338', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'l');
INSERT INTO `user_info` VALUES (7, '陳遠宏', 'INNOLUX', '85165', 'set', NULL, '18013030', '18013030', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (8, '徐思怡', 'INNOLUX', '81707', 'set', NULL, '17008226', '17008226', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (9, '陳健麗', 'INNOLUX', '81822', 'set', NULL, '17012332', '17012332', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (10, '莫曉玲', 'INNOLUX', '80787', 'set', NULL, '17015781', '17015781', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (11, '覃家銘', 'INNOLUX', '87546', 'set', NULL, '17016456', '17016456', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (12, '楊春蘭', 'INNOLUX', '82125', 'set', NULL, '18002496', '18002496', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (13, '李元安', 'INNOLUX', '89150', 'set', NULL, '18010811', '18010811', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (14, '陸坤雄', 'INNOLUX', '82228', 'set', NULL, '18014265', '18014265', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (15, 'admin', 'INNOLUX', NULL, 'set', NULL, '88888888', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'a');
INSERT INTO `user_info` VALUES (16, '李嘉俊', 'INNOLUX', '81864', 'set', NULL, '19001260', '19001260', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (17, '张超鹏', 'INNOLUX', '82104', 'set', NULL, '19004113', '19004113', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (18, '陈焕和', 'INNOLUX', '81705', 'set', NULL, '19004470', '19004470', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's');
INSERT INTO `user_info` VALUES (19, '0101', NULL, NULL, NULL, NULL, '', '0101', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `user_info` VALUES (20, '0102', NULL, NULL, NULL, NULL, '', '0102', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
